  ...
  return (
      <Container id="landing-page" fluid className="p-5">
        <Row className="align-items-center text-center mb-5">
          <Col className="section-padding">
            <div className="text-background">
              ...
              <p className="high-contrast-text">Your online platform for managing, supporting, and evaluating your
                soccer team.</p>
            </div>
          </Col>
        </Row>
        ...
        <Row className="text-center mb-5">
          <Col xs={12} md={4}>
            <div className="text-background">
              ...
              <p className="high-contrast-text">Easily plan and manage your team's schedules, from games to practice
                sessions.</p>
            </div>
          </Col>
          <Col xs={12} md={4}>
            <div className="text-background">
              ...
              <p className="high-contrast-text">Get detailed insights into player metrics and game performances through
                video analysis.</p>
            </div>
          </Col>
          <Col xs={12} md={4}>
            <div className="text-background">
              ...
              <p className="high-contrast-text">Enhance team collaboration with easy-to-use communication tools and
                shared resources.</p>
            </div>
          </Col>
        </Row>
        ...
        <Row className="text-center">
          <Col xs={12}>
            <Button variant="success" size="lg" onClick={handleJoinNowClick}>Join Now and Elevate Your Team's
              Performance</Button>
          </Col>
        </Row>
      </Container>
